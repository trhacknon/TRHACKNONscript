...
head = raw_input("[ Input Your Name ] : ")
heading = raw_input("[ Input Your Group Name ] : ")
message = raw_input("[ Input Your Message ] : ")
### Open The Index 
fo = open("TRHACKNONscript.html","w")
...
<link rel="SHORTCUT ICON" href="https://b.top4top.io/p_210130c5s0.gif" type="image/x-icon"/>
...
@-webkit-keyframes jerkwhole {
  30% {  }e(1,1);  -webkit-transform:skew(0,0);}
  ...
  40% { opacity:1; top:0; left:0;  -webkit-transform:scal}
  65% { }
} 
</style>
</head> """
...
<div class="twinkling">
  <center><br><br><br>
    ...
    <font color="#00FF00" size="4"></font><br>
<br>
<br><font color="#F50808"><b>--TRHACKNOnimous--</b></font><font color="#F50808"></font><font color="#FCFBFB"><b> --Anonymous France--</b></font><br>
<br>
<font color="#F60E05">
<div id="Greets"> 
 <center> """
messagescript6 = """
  <span class="white" font-size="16"><h2>Message:</h2></span> <br> <marquee width="820" scrollamount="4" scrolldelay="50" style="width: 820px;"> <span style="font-size:15pt;"> """
messagescript7 = message
messagescript8 = """ </span> </marquee> </div> """
messagescript9 = """
  <div id="Greets"> 
  <span class="glow" style="font-size:11pt;"><h2>Supported</h2></span> <br> <marquee width="820" scrollamount="4" scrolldelay="50" style="width: 820px;"> <span style="font-size:13pt;">
    | trhacknon | Anticapitaliste crew | ./TuanDestroy | Mr.D1J5 | Mr.SoBong | lvilain antifa | LMARSUP ilami | XXXXXXXXXXXX | lvilain anticap | Mr.D1J5 | hs.sa27 | K1773N | jackalv | 703L |
</center></span> </marquee> </div> 
</font>
  <br>
      <font face="Play">
          </font>
...
const phrases = [
'| """ 
messagescript12 = head
messagescript13 = """|',
  '| """ 
messagescript14 = heading
messagescript15 = """ |',
  'You Lose!', """
...
<h1>Thanks for using this tools..</h1>
</body>
</html> """
...
#kecepatan mengetik
        time.sleep(random.random() * 0.2)
mengetik('TRHACKNONscript Telah berhasil di buat Silahkan Buka Scriptnya di Internal Dengan nama Folder TRHACKNOnimous Dan nama Scriptnya TRHACKNONscript.html \n Thanks for Using this Tools')

fo.close()

os.system("wget https://raw.githubusercontent.com/trhacknon/TRHACKNONdef/main/trhacknodef.py")
